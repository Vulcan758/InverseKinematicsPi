...
def check_pos_validity(x, y, z, a_1, a_2, a_3, a_4):
...
while True:
    ...
    check_pos_validity(x, y, z, a_1, a_2, a_3, a_4)
    theta_1, theta_2, theta_3 = InverseKinematics4DOF(x, y, z,
a_1, a_2, a_3, a_4)
    
    smoother(theta_1, t, 0)
    smoother(theta_2, t, 1)
    smoother(theta_3, t, 2)
